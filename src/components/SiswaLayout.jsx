...
export default function SiswaLayout({ children, title }) {
  ...
  const isActive = (item) => {
    ...
    if (item.path === "/siswa/tugas-susulan") {
      return location.pathname.startsWith("/siswa/tugas-susulan");
    }
