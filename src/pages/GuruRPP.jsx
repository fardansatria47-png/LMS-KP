    ...
    <GuruLayout title="Rencana Pelaksanaan Pembelajaran (RPP)">
      <div className="px-4 sm:px-6 lg:px-10 py-6 lg:py-10">
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-200 bg-white py-10 text-center shadow-sm">
            ...
            <h3 className="text-base font-bold text-slate-700">Belum ada RPP</h3>
            <p className="mt-1 text-sm text-slate-500">Mulai buat RPP dengan klik tombol di pojok kanan atas.</p>
          </div>
        ) : (
