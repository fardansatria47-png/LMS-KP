                        ...
                        <table className="w-full border-collapse">
                          <thead>
                            <tr className="bg-slate-50 border-b border-slate-100">
                              <th className="px-5 py-3 text-left text-xs font-bold uppercase tracking-wider text-slate-500">Nama</th>
                              <th className="px-5 py-3 text-left text-xs font-bold uppercase tracking-wider text-slate-500">NIS</th>
                              <th className="px-5 py-3 text-left text-xs font-bold uppercase tracking-wider text-slate-500">Jenis Kelamin</th>
                            ...
                            {filtered.map((s, idx) => {
                              ...
                              return (
                                ...
                                >
                                  ...
                                  <td className="px-5 py-3.5 text-sm text-slate-500 font-mono">{nis}</td>
                                  <td className="px-5 py-3.5 text-sm text-slate-600">{gender}</td>
                                  <td className="px-5 py-3.5">
