  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        formData.append("lampiran", selectedFile); // Tambahan: antisipasi backend butuh key lampiran
      }
      ...
      // Ekstrak pesan error validasi Laravel jika ada
            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
              ...
              <div className="w-full lg:w-1/3 flex flex-col gap-6">
                ...
                <div className="rounded-[24px] bg-white p-6 shadow-[0_2px_12px_-4px_rgba(0,0,0,0.08)] border border-slate-100">
                  ...
                  {isSubmitted && (statusPengumpulan?.file || statusPengumpulan?.link) && (
                    <div className="mt-5">
                      <span className="text-xs font-semibold text-[#0F172A] block mb-2">Jawaban Anda:</span>
                      <div className="space-y-3">
                        {statusPengumpulan?.file && (
                        ...
                        {statusPengumpulan?.link && (
                          <div className="flex items-center justify-between rounded-lg bg-emerald-50 p-3 border border-emerald-100">
                            <div className="flex items-center gap-3 overflow-hidden">
                              ...
                              <a href={statusPengumpulan.link} target="_blank" rel="noreferrer" className="text-sm font-semibold text-emerald-800 hover:underline truncate">
                                {statusPengumpulan.link}
                              </a>
                            </div>
                          </div>
                ...
                {/* Card Upload Tugas */}
                {!isSubmitted && (
                  <div className="rounded-[24px] bg-[#F8FAFC] p-6 border border-slate-200 mt-6 lg:mt-0">
                      ...
                      <>
                        <div className="space-y-4">
                          ...
                          <div className="border border-slate-200 bg-white rounded-[16px] p-5 shadow-sm">
                            <label className="text-xs font-bold text-slate-700 block mb-2">Tautan/Link Jawaban:</label>
                            <div className="relative">
                              ...
                              <input
                                ...
                                className="w-full rounded-xl border border-slate-200 py-3 pl-9 pr-4 text-xs text-slate-700 shadow-sm focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-100"
                              />
                            </div>
                            <p className="text-[10px] text-slate-400 mt-2">Pastikan link dapat diakses secara publik (misal shared link Google Drive)</p>
                          </div>
                        </div>
